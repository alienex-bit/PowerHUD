...
- **Profiles:** Save/load/delete HUD layouts for quick switching between custom setups. Instantly switch between different HUD configurations and layouts. Profiles are stored and can be restored at any time, making it easy to experiment or revert to a favorite layout.
...
## Changelog
- 1.11.4: Profiles feature improved and documented. Version bump. Profiles are now fully integrated and allow restoring/saving layouts easily.
